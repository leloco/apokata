...
**apokata** (derived from Greek for *restoration/reconstitution*) is a fully automated, reproducible hybrid infrastructure environment built on GitOps principles.
...
Project progression and architectural refactoring are actively tracked via GitHub Milestones:

👉 **[View Project Milestones & Progress](https://github.com/leloco/apokata/milestones)**
